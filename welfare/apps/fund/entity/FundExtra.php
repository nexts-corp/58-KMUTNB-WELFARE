...
/**
 * @Entity
 * @Table(name="FundExtra")
 */
class FundExtra extends EntityBase {

    /**
     * @Id
     * @GeneratedValue
     * @Column(type="integer" , length=11, name="fundExId") 
     */
    public $fundExId;
    ...
    function getFundExId() {
        return $this->fundExId;
    }
    ...
    function setFundExId($fundExId) {
        $this->fundExId = $fundExId;
    }
