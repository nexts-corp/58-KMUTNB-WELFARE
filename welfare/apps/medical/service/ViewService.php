...
class ViewService extends CServiceBase implements IViewService {
    ...
    public function medicalFeeLists() {
        ...
        $sql = "SELECT me.medicalFeeId,ti.titleNameTh,re.registerNameTh,re.registerLastNameTh,me.amount,ho.name "
                ...
                . "INNER join " . $path . "Hospital ho with me.hospital = ho.hospitalId "
                . "ORDER BY re.registerId DESC";
        $getObj = $this->datacontext->getObject($sql);
        $view->datas = $getObj;

        return $view;
    }

    // end serviec view medicalFee  
    // start serviec view report  
    public function reportLists() {
        $view = new CJView("report/lists", CJViewType::HTML_VIEW_ENGINE);
        return $view;
    }

    // end serviec view report  
}
